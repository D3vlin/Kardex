...
public class UserDeleteTest
{
    ...
    public UserDeleteTest(int userId, String userName, String userPass, String identification, String realName, String surname, short userProfile, short state)
    {
        this.userId = userId;
    ...
    public static Collection data()
    {
        ...
        {
            {999999, "AdminTest", "Test 1", "87654321", "Test", "Update", (short) 1, (short) 3},
            {999998, "UserTest", "Test 2", "12345678", "Test", "Update", (short) 0, (short) 3}
        });
    }
