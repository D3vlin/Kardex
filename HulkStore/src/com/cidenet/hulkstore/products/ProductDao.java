...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 * @param userConn
	 */
	public ProductDao(final java.sql.Connection userConn)
	{
	 ...
	 */
	protected ProductView[] fetchProductView(ResultSet rs) throws SQLException
	{
	 ...
	 * Fetches multiple rows from the result set
	 */
	protected ProductDto[] fetchProductDto(ResultSet rs) throws SQLException
	{
	...
	protected ArrayList fetchMultiResults(ResultSet rs, boolean view) throws SQLException
	{
            ...
            while (rs.next()) {
                ...
                if(view) {
                    ...
                    populateViewProduct( viewProduct, rs);
                    resultList.add( viewProduct );
                } else {                            
                    ProductDto productDto = new ProductDto();
                    populateDto( productDto, rs);
	 ...
	 */
	protected void populateViewProduct(ProductView viewProduct, ResultSet rs) throws SQLException
	{
            viewProduct.setProductId( rs.getInt( COLUMN_VIEW_PRODUCT_ID ) );
            viewProduct.setProductName( rs.getString( COLUMN_VIEW_PRODUCT_NAME ) );
            viewProduct.setUnityDescription( rs.getString( COLUMN_VIEW_UNITY_DESCRIPTION ) );
	}
