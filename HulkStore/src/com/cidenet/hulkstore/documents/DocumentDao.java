...
public final class DocumentDao extends AbstractDAO
{
     ...
     */
    private final String SQL_SELECT = "SELECT documentId, documentDescription, state FROM " + getTableName() + "";
     ...
     */
    private final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( documentId, documentDescription, state ) VALUES ( ?, ?, ? )";
    ...
    {
        DocumentDto documentDto[] = findByDynamicSelect( SQL_SELECT + " WHERE documentId = ?", new Object[] { documentId } );
    ...
    */
     ...
     * @return String
     */
    private String getTableName() { return "bd_hulkstore.document"; }
