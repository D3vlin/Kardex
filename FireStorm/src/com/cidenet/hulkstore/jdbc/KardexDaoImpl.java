...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	{
		Kardex ret[] = findByDynamicSelect( SQL_SELECT + " WHERE productId = ? AND storeId = ?", new Object[] {  new Integer(productId),  new Integer(storeId) } );
	 ...
	 */
	protected Kardex fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			Kardex dto = new Kardex();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected Kardex[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Kardex ret[] = new Kardex[ resultList.size() ];
	 ...
	 */
	protected void populateDto(Kardex dto, ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void reset(Kardex dto)
	{
	}
